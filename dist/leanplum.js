...
function () {
  ...
  _createClass(Leanplum, null, [{
    ...
    value: function track(event, value, info, params, messageId) {
      ...
      _Events["default"].publish('messages', {
        messages: Leanplum.getFilteredResults(_VarCache["default"].getMessages(), 'event', 'triggers', event)
      });
